    ...
    public static class Paths {
        ...
        public static string ManagedFolder {
            get {
                ...
                return _ManagedFolder = Path.GetDirectoryName(typeof(Paths).Assembly.Location);
            }
        }
        ...
        public static string ResourcesFolder {
            get {
                ...
                return _ResourcesFolder = Path.Combine(ManagedFolder, "ModUntitled/Resources");
            }
        }
        ...
        public static string CacheFolder {
            get {
                ...
                return _CacheFolder = Path.Combine(GameFolder, ".ModUntitledCache");
            }
        }
